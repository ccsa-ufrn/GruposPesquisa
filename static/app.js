    ...
    render() {
        return(
            <div>
                ...
                <button onClick={() => this.props.submit("final")} className="btn btn-primary">Enviar formulário</button>
            </div>
        );
    }
}
...
class Application extends React.Component {
    ...
    submit(state) {
        const result = Object.assign({}, this.state, {"state": state});
    ...
    getInformation() {
        const data = {'groupAccount': this.state.groupAccount};
        const config = {
            mode: 'cors',
            headers: {
                'Accept': 'application/json',
